...
const collectors = [
  ...
  { type: 'file', source: '/etc/nut/upsd.users', target: 'config/system/nut/upsd.users' },
  { type: 'file', source: '/etc/nut/upsmon.conf', target: 'config/system/nut/upsmon.conf' },
  { type: 'file', source: '/etc/nut/upssched.conf', target: 'config/system/nut/upssched.conf' },
